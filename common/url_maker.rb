...
Premium Search example:
	labels = {}
  labels['product'] = '30day'
	labels['label'] = 'dev'
	search-app.countURL = URLMaker.getSearchDataURL('premium', labels)
...
Enterprise Search example:
    ...
    ==> https://gnip-api.twitter.com/search/30day/accounts/thinksnow/dev/counts.json

Enterprise Engagement API example:
  labels = {}
	labels['endpoint'] = 'totals'
  engagement-app.URL = URLMaker.getEngagementURL('enterprise', labels)
